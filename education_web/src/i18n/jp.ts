...
const jpJA: any = {
    ...
    'toast': {
        ...
        'student_over_limit': '超出参加者最大人数，请等待30秒或重新创建教室',
        'teacher_and_student_over_limit': '超出参加者和主持人的最大人数',
        ...
        'student_cancel_co_video': '参加者已取消连麦',
        'student_send_co_video_apply': '"{reason}" 参加者发起了连麦申请',
        'student_peer_leave': '"{reason}" 离开了',
        'stop_co_video': '主持人停止了"{reason}"的连麦',
        'reject_co_video': '您取消了参加者的连麦申请',
        'close_co_video': '您关闭了参加者的连麦',
